...
module.exports = {
    generateConfig: async targetDir => {
        ...
        let data = {
            ...
            vueViewFileType: templateData.vue.view.fileType,
            vueViewData: templateData.vue.view.data,
            ...
            routerModuleFileType: templateData.vueRouter.module.fileType,
            routerModuleData: templateData.vueRouter.module.data,
            routerActionData: templateData.vueRouter.action.data,
        }
