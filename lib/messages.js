...
module.exports = {
    ...
    configExists: () => console.log(`${emojis.error}  Cannot initialize app -- ${APP_CONFIG_FILE} already exists`),
    configDoesNotExist: () => console.log(`${emojis.error}  Cannot find ${APP_CONFIG_FILE} file`),
